...
if (!function_exists('student_detail_search')) {
    ...
    function student_detail_search($search_query) {
        ...
        $CI->db->join('admission_plan', 'admission_plan.admission_plan_id = student.admission_plan_id');
...
if (!function_exists('exam_search')) {
    ...
    function exam_search($search_query) {
        ...
        $CI->db->join('branch_location', 'branch_location.branch_id = exam_manager.branch_id');
        $CI->db->join('admission_plan', 'admission_plan.admission_plan_id = exam_manager.admission_plan_id');
